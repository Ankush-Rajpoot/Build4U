          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            ...
            {summary && (
              <div className="grid grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6">
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg p-2 sm:p-3 hover:from-emerald-100 hover:to-emerald-150 transition-all duration-200 shadow-sm">
                ...
                <div className="bg-gradient-to-br from-amber-50 to-amber-100 border border-amber-200 rounded-lg p-2 sm:p-3 hover:from-amber-100 hover:to-amber-150 transition-all duration-200 shadow-sm">
                  <div className="flex items-center mb-1 sm:mb-2">
                    ...
                    <span className="text-xs sm:text-sm font-semibold text-amber-800 leading-tight">Pending</span>
                  </div>
                  <p className="text-sm sm:text-lg lg:text-xl font-bold text-amber-900">
                    {formatCurrency(summary.amountPending || 0)}
                  </p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-2 sm:p-3 hover:from-blue-100 hover:to-blue-150 transition-all duration-200 shadow-sm">
                  <div className="flex items-center mb-1 sm:mb-2">
                    ...
                    <span className="text-xs sm:text-sm font-semibold text-blue-800 leading-tight">
                      {(userType === 'worker' || userType === 'Worker') ? 'Budget Left' : 'Remaining'}
                    </span>
                  </div>
                  <p className="text-sm sm:text-lg lg:text-xl font-bold text-blue-900">
                ...
                <div className="space-y-3">
                  {paymentRequests.map((request, index) => (
                    <div
                      ...
                      className="bg-white border border-slate-200 rounded-lg p-4 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-sm hover:shadow-md"
                    >
                      ...
                      {(userType === 'client' || userType === 'Client') && request.status === 'pending' && (
                        <div className="flex space-x-3 mt-4 pt-3 border-t border-gray-200">
                          ...
                          <button
                            ...
                            className="flex-1 px-4 py-2.5 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 hover:text-slate-800 transition-all duration-200 text-sm font-semibold border border-slate-300"
                          >
                            Decline
                          </button>
                        </div>
          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600">Full modal view - implement as needed</p>
              </div>
            )}
          </div>
        </div>
